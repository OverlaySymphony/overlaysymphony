...
import {
  ...
  makeChannelAdBreakBeginSubscription,
} from "./channel.ad_break.begin.js"
import {
  ChannelBanEvent,
  ChannelBanSubscription,
  makeChannelBanSubscription,
} from "./channel.ban.js"
import {
  ChannelPointsCustomRewardAddEvent,
  ChannelPointsCustomRewardAddSubscription,
  makeChannelPointsCustomRewardAddSubscription,
} from "./channel.channel_points_custom_reward.add.js"
import {
  ChannelPointsCustomRewardRemoveEvent,
  ChannelPointsCustomRewardRemoveSubscription,
  makeChannelPointsCustomRewardRemoveSubscription,
} from "./channel.channel_points_custom_reward.remove.js"
import {
  ChannelPointsCustomRewardUpdateEvent,
  ChannelPointsCustomRewardUpdateSubscription,
  makeChannelPointsCustomRewardUpdateSubscription,
} from "./channel.channel_points_custom_reward.update.js"
import {
  ChannelPointsCustomRewardRedemptionAddEvent,
  ChannelPointsCustomRewardRedemptionAddSubscription,
  makeChannelPointsCustomRewardRedemptionAddSubscription,
} from "./channel.channel_points_custom_reward_redemption.add.js"
import {
  ChannelPointsCustomRewardRedemptionUpdateEvent,
  ChannelPointsCustomRewardRedemptionUpdateSubscription,
  makeChannelPointsCustomRewardRedemptionUpdateSubscription,
} from "./channel.channel_points_custom_reward_redemption.update.js"
import {
  CharityDonationEvent,
  CharityDonationSubscription,
  makeCharityDonationSubscription,
} from "./channel.charity_campaign.donate.js"
import {
  CharityCampaignProgressEvent,
  CharityCampaignProgressSubscription,
  makeCharityCampaignProgressSubscription,
} from "./channel.charity_campaign.progress.js"
import {
  CharityCampaignStartEvent,
  CharityCampaignStartSubscription,
  makeCharityCampaignStartSubscription,
} from "./channel.charity_campaign.start.js"
import {
  CharityCampaignStopEvent,
  CharityCampaignStopSubscription,
  makeCharityCampaignStopSubscription,
} from "./channel.charity_campaign.stop.js"
import {
  ChannelChatClearEvent,
  ChannelChatClearSubscription,
  makeChannelChatClearSubscription,
} from "./channel.chat.clear.js"
import {
  ChannelChatClearUserMessagesEvent,
  ChannelChatClearUserMessagesSubscription,
  makeChannelChatClearUserMessagesSubscription,
} from "./channel.chat.clear_user_messages.js"
import {
  ChannelChatMessageDeleteEvent,
  ChannelChatMessageDeleteSubscription,
  makeChannelChatMessageDeleteSubscription,
} from "./channel.chat.message_delete.js"
import {
  ChannelChatNotificationEvent,
  ChannelChatNotificationSubscription,
  makeChannelChatNotificationSubscription,
} from "./channel.chat.notification.js"
import {
  ChannelCheerEvent,
  ChannelCheerSubscription,
  makeChannelCheerSubscription,
} from "./channel.cheer.js"
import {
  ChannelFollowEvent,
  ChannelFollowSubscription,
  makeChannelFollowSubscription,
} from "./channel.follow.js"
import {
  GoalBeginEvent,
  GoalBeginSubscription,
  makeGoalBeginSubscription,
} from "./channel.goal.begin.js"
import {
  GoalEndEvent,
  GoalEndSubscription,
  makeGoalEndSubscription,
} from "./channel.goal.end.js"
import {
  GoalProgressEvent,
  GoalProgressSubscription,
  makeGoalProgressSubscription,
} from "./channel.goal.progress.js"
import {
  ChannelGuestStarGuestUpdateEvent,
  ChannelGuestStarGuestUpdateSubscription,
  makeChannelGuestStarGuestUpdateSubscription,
} from "./channel.guest_star_guest.update.js"
import {
  ChannelGuestStarSessionBeginEvent,
  ChannelGuestStarSessionBeginSubscription,
  makeChannelGuestStarSessionBeginSubscription,
} from "./channel.guest_star_session.begin.js"
import {
  ChannelGuestStarSessionEndEvent,
  ChannelGuestStarSessionEndSubscription,
  makeChannelGuestStarSessionEndSubscription,
} from "./channel.guest_star_session.end.js"
import {
  ChannelGuestStarSettingsUpdateEvent,
  ChannelGuestStarSettingsUpdateSubscription,
  makeChannelGuestStarSettingsUpdateSubscription,
} from "./channel.guest_star_settings.update.js"
import {
  HypeTrainBeginEvent,
  HypeTrainBeginSubscription,
  makeHypeTrainBeginSubscription,
} from "./channel.hype_train.begin.js"
import {
  HypeTrainEndEvent,
  HypeTrainEndSubscription,
  makeHypeTrainEndSubscription,
} from "./channel.hype_train.end.js"
import {
  HypeTrainProgressEvent,
  HypeTrainProgressSubscription,
  makeHypeTrainProgressSubscription,
} from "./channel.hype_train.progress.js"
import {
  ChannelModeratorAddEvent,
  ChannelModeratorAddSubscription,
  makeChannelModeratorAddSubscription,
} from "./channel.moderator.add.js"
import {
  ChannelModeratorRemoveEvent,
  ChannelModeratorRemoveSubscription,
  makeChannelModeratorRemoveSubscription,
} from "./channel.moderator.remove.js"
import {
  ChannelPollBeginEvent,
  ChannelPollBeginSubscription,
  makeChannelPollBeginSubscription,
} from "./channel.poll.begin.js"
import {
  ChannelPollEndEvent,
  ChannelPollEndSubscription,
  makeChannelPollEndSubscription,
} from "./channel.poll.end.js"
import {
  ChannelPollProgressEvent,
  ChannelPollProgressSubscription,
  makeChannelPollProgressSubscription,
} from "./channel.poll.progress.js"
import {
  ChannelPredictionBeginEvent,
  ChannelPredictionBeginSubscription,
  makeChannelPredictionBeginSubscription,
} from "./channel.prediction.begin.js"
import {
  ChannelPredictionEndEvent,
  ChannelPredictionEndSubscription,
  makeChannelPredictionEndSubscription,
} from "./channel.prediction.end.js"
import {
  ChannelPredictionLockEvent,
  ChannelPredictionLockSubscription,
  makeChannelPredictionLockSubscription,
} from "./channel.prediction.lock.js"
import {
  ChannelPredictionProgressEvent,
  ChannelPredictionProgressSubscription,
  makeChannelPredictionProgressSubscription,
} from "./channel.prediction.progress.js"
import {
  ChannelRaidEvent,
  ChannelRaidSubscription,
  makeChannelRaidSubscription,
} from "./channel.raid.js"
import {
  ShieldModeBeginEvent,
  ShieldModeBeginSubscription,
  makeShieldModeBeginSubscription,
} from "./channel.shield_mode.begin.js"
import {
  ShieldModeEndEvent,
  ShieldModeEndSubscription,
  makeShieldModeEndSubscription,
} from "./channel.shield_mode.end.js"
import {
  ShoutoutCreateEvent,
  ShoutoutCreateSubscription,
  makeShoutoutCreateSubscription,
} from "./channel.shoutout.create.js"
import {
  ShoutoutReceiveEvent,
  ShoutoutReceiveSubscription,
  makeShoutoutReceiveSubscription,
} from "./channel.shoutout.receive.js"
import {
  ChannelSubscribeEvent,
  ChannelSubscribeSubscription,
  makeChannelSubscribeSubscription,
} from "./channel.subscribe.js"
import {
  ChannelSubscriptionEndEvent,
  ChannelSubscriptionEndSubscription,
  makeChannelSubscriptionEndSubscription,
} from "./channel.subscription.end.js"
import {
  ChannelSubscriptionGiftEvent,
  ChannelSubscriptionGiftSubscription,
  makeChannelSubscriptionGiftSubscription,
} from "./channel.subscription.gift.js"
import {
  ChannelSubscriptionMessageEvent,
  ChannelSubscriptionMessageSubscription,
  makeChannelSubscriptionMessageSubscription,
} from "./channel.subscription.message.js"
import {
  ChannelUnbanEvent,
  ChannelUnbanSubscription,
  makeChannelUnbanSubscription,
} from "./channel.unban.js"
import {
  ChannelUpdateEvent,
  ChannelUpdateSubscription,
  makeChannelUpdateSubscription,
} from "./channel.update.js"
import {
  StreamOfflineEvent,
  StreamOfflineSubscription,
  makeStreamOfflineSubscription,
} from "./stream.offline.js"
import {
  StreamOnlineEvent,
  StreamOnlineSubscription,
  makeStreamOnlineSubscription,
} from "./stream.online.js"
import {
  UserUpdateEvent,
  UserUpdateSubscription,
  makeUserUpdateSubscription,
} from "./user.update.js"
